...
public class ArticleCommentSchema {
    ...
    public com.only4.domain.aggregates.article_comment.meta.ArticleCommentStatisticsSchema joinArticleCommentStatistics(Schema.JoinType joinType) {
        ...
        Join<ArticleComment, com.only4.domain.aggregates.article_comment.ArticleCommentStatistics> join = ((Root<ArticleComment>) root).join("articleCommentStatistics", type);
        com.only4.domain.aggregates.article_comment.meta.ArticleCommentStatisticsSchema schema = new com.only4.domain.aggregates.article_comment.meta.ArticleCommentStatisticsSchema(join, criteriaBuilder);
        return schema;
    }
