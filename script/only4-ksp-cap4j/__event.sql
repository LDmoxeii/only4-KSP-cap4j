...
create index idx_create_at on __event (create_at);

create index idx_db_created_at on __event (db_created_at);

create index idx_db_updated_at on __event (db_updated_at);

create index idx_event_type on __event (event_type, svc_name);

create index idx_event_uuid on __event (event_uuid);

create index idx_expire_at on __event (expire_at);

create index idx_next_try_time on __event (next_try_time);
