...
create index idx_db_created_at on __archived_saga_process (db_created_at);

create index idx_db_updated_at on __archived_saga_process (db_updated_at);

create index idx_saga_id on __archived_saga_process (saga_id);
