...
create index idx_create_at on __saga (create_at);

create index idx_db_created_at on __saga (db_created_at);

create index idx_db_updated_at on __saga (db_updated_at);

create index idx_expire_at on __saga (expire_at);

create index idx_next_try_time on __saga (next_try_time);

create index idx_saga_type on __saga (saga_type, svc_name);

create index idx_saga_uuid on __saga (saga_uuid);
