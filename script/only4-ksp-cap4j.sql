...
CREATE TABLE `__achrived_event`  (
  ...
  `event_state` int NOT NULL DEFAULT 0 COMMENT '分发状态',
  ...
  INDEX `idx_db_created_at`(`db_created_at` ASC) USING BTREE,
  INDEX `idx_db_updated_at`(`db_updated_at` ASC) USING BTREE,
  INDEX `idx_event_uuid`(`event_uuid` ASC) USING BTREE,
  INDEX `idx_event_type`(`event_type` ASC, `svc_name` ASC) USING BTREE,
  INDEX `idx_create_at`(`create_at` ASC) USING BTREE,
  INDEX `idx_expire_at`(`expire_at` ASC) USING BTREE,
  INDEX `idx_next_try_time`(`next_try_time` ASC) USING BTREE
...
CREATE TABLE `__archived_saga`  (
  ...
  INDEX `idx_db_created_at`(`db_created_at` ASC) USING BTREE,
  INDEX `idx_db_updated_at`(`db_updated_at` ASC) USING BTREE,
  INDEX `idx_saga_uuid`(`saga_uuid` ASC) USING BTREE,
  INDEX `idx_saga_type`(`saga_type` ASC, `svc_name` ASC) USING BTREE,
  INDEX `idx_create_at`(`create_at` ASC) USING BTREE,
  INDEX `idx_expire_at`(`expire_at` ASC) USING BTREE,
  INDEX `idx_next_try_time`(`next_try_time` ASC) USING BTREE
...
CREATE TABLE `__archived_saga_process`  (
  ...
  INDEX `idx_db_created_at`(`db_created_at` ASC) USING BTREE,
  INDEX `idx_db_updated_at`(`db_updated_at` ASC) USING BTREE,
  INDEX `idx_saga_id`(`saga_id` ASC) USING BTREE
...
CREATE TABLE `admin_user`  (
  ...
  `login_expiry_date` timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP COMMENT '过期时间',
...
CREATE TABLE `admin_user_permission`  (
  `id` bigint NOT NULL COMMENT 'ID',
  `admin_user_id` bigint NULL DEFAULT NULL COMMENT '用户ID',
...
CREATE TABLE `article`  (
  ...
  `state` int NULL DEFAULT NULL COMMENT '文章状态@T=ArticleState;@E=0:INIT;',
...
CREATE TABLE `article_comment_like`  (
  `id` bigint NOT NULL COMMENT 'ID',
  `customer_id` bigint NULL DEFAULT NULL COMMENT '消费者ID',
  `comments` bigint NULL DEFAULT NULL COMMENT '评论ID',
  `del_flag` tinyint(1) NULL DEFAULT NULL COMMENT '逻辑删除',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `article_comment_statistics`  (
  `id` bigint NOT NULL COMMENT 'ID',
  `article_comment_id` bigint NULL DEFAULT NULL COMMENT '文章评论ID',
  `likes` bigint NULL DEFAULT NULL COMMENT '点赞数',
  `reports` bigint NULL DEFAULT NULL COMMENT '举报数',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `article_statistics`  (
  ...
  `likes` bigint NULL DEFAULT NULL COMMENT '点赞数',
  `reports` bigint NULL DEFAULT NULL COMMENT '举报数',
  `comments` bigint NULL DEFAULT NULL COMMENT '评论数',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `block`  (
  `id` bigint NOT NULL COMMENT 'ID',
  `block_id` bigint NULL DEFAULT NULL COMMENT '拉黑人ID',
  `blocked_id` bigint NULL DEFAULT NULL COMMENT '被拉黑人ID',
  `del_flag` tinyint NULL DEFAULT NULL COMMENT '逻辑删除',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `customer`  (
  ...
  `password` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '密码',
  `balance` bigint NULL DEFAULT NULL COMMENT '余额',
...
CREATE TABLE `customer_statistics`  (
  `id` bigint NOT NULL COMMENT 'ID',
  `customer_id` bigint NULL DEFAULT NULL COMMENT '消费者ID',
  `rank` bigint NULL DEFAULT NULL COMMENT '经验',
  `likes` bigint NULL DEFAULT NULL COMMENT '点赞数',
  `fans` bigint NULL DEFAULT NULL COMMENT '粉丝数',
  `reports` bigint NULL DEFAULT NULL COMMENT '举报数',
  `follows` bigint NULL DEFAULT NULL COMMENT '关注数',
  `works` bigint NULL DEFAULT NULL COMMENT '作品数',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '@P=customer;' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `favorites`  (
  ...
  `description` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '描述',
  `state` int NULL DEFAULT NULL COMMENT '收藏夹状态@T=FavoritesState;@E=0:INIT;',
...
CREATE TABLE `follow`  (
  `id` bigint NOT NULL COMMENT 'ID',
  `follow_id` bigint NULL DEFAULT NULL COMMENT '关注人ID',
  `followed_id` bigint NULL DEFAULT NULL COMMENT '被关注人ID',
  `del_flag` tinyint(1) NULL DEFAULT NULL COMMENT '逻辑删除',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `order`  (
  ...
  `type` int NULL DEFAULT NULL COMMENT '类型@T=OrderType;@E=0:INIT;',
  `state` int NULL DEFAULT NULL COMMENT '订单状态@T=OrderState;@E=0:INIT;',
  `price` bigint NULL DEFAULT NULL COMMENT '总价格',
  `actual_price` bigint NULL DEFAULT NULL COMMENT '实付价格',
...
CREATE TABLE `star`  (
  `id` bigint NOT NULL COMMENT 'ID',
  `master_id` bigint NULL DEFAULT NULL COMMENT '星主ID',
...
CREATE TABLE `star_comment_statistics`  (
  `id` bigint NOT NULL COMMENT 'ID',
  `star_comment_id` int NULL DEFAULT NULL COMMENT '星球评论ID',
  `likes` bigint NULL DEFAULT NULL COMMENT '点赞数',
  `reports` bigint NULL DEFAULT NULL COMMENT '举报数',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `star_statistics`  (
  `id` bigint NOT NULL COMMENT 'ID',
  `star_id` bigint NULL DEFAULT NULL COMMENT '星球ID',
  `stardust` bigint NULL DEFAULT NULL COMMENT '星尘',
  `comments` bigint NULL DEFAULT NULL COMMENT '评论数',
  PRIMARY KEY (`id`) USING BTREE
