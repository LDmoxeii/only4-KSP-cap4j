...
public class MemberWrokSchema {
    ...
    public Schema.Field<Long> workId() {
        return root == null ? new Schema.Field<>("workId") : new Schema.Field<>(root.get("workId"));
    }
    ...
    public static Specification<MemberWrok> specify(Schema.PredicateBuilder<MemberWrokSchema> builder, boolean distinct) {
        return (root, criteriaQuery, criteriaBuilder) -> {
            ...
            criteriaQuery.where(builder.build(memberWrok));
     ...
     * @return
     */
    public static Sort orderBy(Schema.OrderBuilder<MemberWrokSchema>... builders) {
     ...
     * @return
     */
    public static Sort orderBy(Collection<Schema.OrderBuilder<MemberWrokSchema>> builders) {
        if(null == builders || builders.isEmpty()) {
            return Sort.unsorted();
        }
        return Sort.by(builders.stream()
                .map(builder -> builder.build(new MemberWrokSchema(null, null)))
