...
public class MemberPermissionSchema {
    ...
    public Schema.Field<Integer> permissionMark() {
        return root == null ? new Schema.Field<>("permissionMark") : new Schema.Field<>(root.get("permissionMark"));
    }
    ...
    public static Specification<MemberPermission> specify(Schema.PredicateBuilder<MemberPermissionSchema> builder, boolean distinct) {
        return (root, criteriaQuery, criteriaBuilder) -> {
            ...
            criteriaQuery.where(builder.build(memberPermission));
     ...
     * @return
     */
    public static Sort orderBy(Schema.OrderBuilder<MemberPermissionSchema>... builders) {
     ...
     * @return
     */
    public static Sort orderBy(Collection<Schema.OrderBuilder<MemberPermissionSchema>> builders) {
        if(null == builders || builders.isEmpty()) {
            return Sort.unsorted();
        }
        return Sort.by(builders.stream()
                .map(builder -> builder.build(new MemberPermissionSchema(null, null)))
