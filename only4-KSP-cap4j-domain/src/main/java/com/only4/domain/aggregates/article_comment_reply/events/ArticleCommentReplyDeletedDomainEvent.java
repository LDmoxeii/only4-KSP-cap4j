...
/**
 * ArticleCommentReply.ArticleCommentReplyDeletedDomainEvent领域事件
 * 文章评论回复已删除
 *
...
@Aggregate(aggregate = "ArticleCommentReply", name = "ArticleCommentReplyDeletedDomainEvent", type = Aggregate.TYPE_DOMAIN_EVENT, description = "")
@Data
@Builder
@AllArgsConstructor
@NoArgsConstructor
