...
public class MemberStatisticsSchema {
    ...
    public static Specification<MemberStatistics> specify(Schema.PredicateBuilder<MemberStatisticsSchema> builder, boolean distinct) {
        return (root, criteriaQuery, criteriaBuilder) -> {
            ...
            criteriaQuery.where(builder.build(memberStatistics));
     ...
     * @return
     */
    public static Sort orderBy(Schema.OrderBuilder<MemberStatisticsSchema>... builders) {
     ...
     * @return
     */
    public static Sort orderBy(Collection<Schema.OrderBuilder<MemberStatisticsSchema>> builders) {
        if(null == builders || builders.isEmpty()) {
            return Sort.unsorted();
        }
        return Sort.by(builders.stream()
                .map(builder -> builder.build(new MemberStatisticsSchema(null, null)))
