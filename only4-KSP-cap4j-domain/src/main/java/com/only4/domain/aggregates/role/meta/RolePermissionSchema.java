...
public class RolePermissionSchema {
    ...
    public Path<RolePermission> _root() {
        return root;
    }
     ...
     * @return
     */
    public static Specification<RolePermission> specify(Schema.PredicateBuilder<RolePermissionSchema> builder, Schema.OrderBuilder<RolePermissionSchema>... orderBuilders) {
     ...
     * @return
     */
    public static Specification<RolePermission> specify(Schema.PredicateBuilder<RolePermissionSchema> builder, List<Schema.OrderBuilder<RolePermissionSchema>> orderBuilders) {
     ...
     * @return
     */
    public static Specification<RolePermission> specify(Schema.PredicateBuilder<RolePermissionSchema> builder, boolean distinct, Schema.OrderBuilder<RolePermissionSchema>... orderBuilders) {
     ...
     * @return
     */
    public static Specification<RolePermission> specify(Schema.PredicateBuilder<RolePermissionSchema> builder, boolean distinct, List<Schema.OrderBuilder<RolePermissionSchema>> orderBuilders) {
     ...
     * @return
     */
    public static Specification<RolePermission> specify(Schema.Specification<RolePermission, RolePermissionSchema> specifier) {
        return (root, criteriaQuery, criteriaBuilder) -> {
            RolePermissionSchema rolePermission = new RolePermissionSchema(root, criteriaBuilder);
            return specifier.toPredicate(rolePermission, criteriaQuery);
        };
    }
