...
public class ArticleCategorySchema {
    ...
    public Schema.Field<Long> categoryId() {
        return root == null ? new Schema.Field<>("categoryId") : new Schema.Field<>(root.get("categoryId"));
    }
    ...
    public Schema.Field<String> categoryName() {
        return root == null ? new Schema.Field<>("categoryName") : new Schema.Field<>(root.get("categoryName"));
    }
    ...
    public static Specification<ArticleCategory> specify(Schema.PredicateBuilder<ArticleCategorySchema> builder, boolean distinct) {
        return (root, criteriaQuery, criteriaBuilder) -> {
            ...
            criteriaQuery.where(builder.build(articleCategory));
     ...
     * @return
     */
    public static Sort orderBy(Schema.OrderBuilder<ArticleCategorySchema>... builders) {
     ...
     * @return
     */
    public static Sort orderBy(Collection<Schema.OrderBuilder<ArticleCategorySchema>> builders) {
        if(null == builders || builders.isEmpty()) {
            return Sort.unsorted();
        }
        return Sort.by(builders.stream()
                .map(builder -> builder.build(new ArticleCategorySchema(null, null)))
