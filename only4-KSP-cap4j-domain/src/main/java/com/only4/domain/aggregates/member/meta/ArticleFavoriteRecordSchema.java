...
public class ArticleFavoriteRecordSchema {
    ...
    public static Specification<ArticleFavoriteRecord> specify(Schema.PredicateBuilder<ArticleFavoriteRecordSchema> builder, boolean distinct) {
        return (root, criteriaQuery, criteriaBuilder) -> {
            ...
            criteriaQuery.where(builder.build(articleFavoriteRecord));
     ...
     * @return
     */
    public static Sort orderBy(Schema.OrderBuilder<ArticleFavoriteRecordSchema>... builders) {
     ...
     * @return
     */
    public static Sort orderBy(Collection<Schema.OrderBuilder<ArticleFavoriteRecordSchema>> builders) {
        if(null == builders || builders.isEmpty()) {
            return Sort.unsorted();
        }
        return Sort.by(builders.stream()
                .map(builder -> builder.build(new ArticleFavoriteRecordSchema(null, null)))
