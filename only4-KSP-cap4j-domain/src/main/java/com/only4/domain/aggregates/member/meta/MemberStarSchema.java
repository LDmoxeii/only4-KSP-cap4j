...
public class MemberStarSchema {
    ...
    public Schema.Field<String> starName() {
        return root == null ? new Schema.Field<>("starName") : new Schema.Field<>(root.get("starName"));
    }
    ...
    public static Specification<MemberStar> specify(Schema.PredicateBuilder<MemberStarSchema> builder, boolean distinct) {
        return (root, criteriaQuery, criteriaBuilder) -> {
            ...
            criteriaQuery.where(builder.build(memberStar));
     ...
     * @return
     */
    public static Sort orderBy(Schema.OrderBuilder<MemberStarSchema>... builders) {
     ...
     * @return
     */
    public static Sort orderBy(Collection<Schema.OrderBuilder<MemberStarSchema>> builders) {
        if(null == builders || builders.isEmpty()) {
            return Sort.unsorted();
        }
        return Sort.by(builders.stream()
                .map(builder -> builder.build(new MemberStarSchema(null, null)))
