...
public class CategorySchema {
    ...
    public static Specification<Category> specify(Schema.PredicateBuilder<CategorySchema> builder, boolean distinct) {
        return (root, criteriaQuery, criteriaBuilder) -> {
            ...
            criteriaQuery.where(builder.build(category));
     ...
     * @return
     */
    public static Sort orderBy(Schema.OrderBuilder<CategorySchema>... builders) {
     ...
     * @return
     */
    public static Sort orderBy(Collection<Schema.OrderBuilder<CategorySchema>> builders) {
        if(null == builders || builders.isEmpty()) {
            return Sort.unsorted();
        }
        return Sort.by(builders.stream()
                .map(builder -> builder.build(new CategorySchema(null, null)))
