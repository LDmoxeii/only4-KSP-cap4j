 ...
 * @date 2025/02/17
 */
@Aggregate(aggregate = "StarCommentLike", name = "StarCommentLike", root = true, type = Aggregate.TYPE_VALUE_OBJECT, description = "星球评论点赞")
@Entity
...
@Builder
@Getter
public class StarCommentLike implements ValueObject<Long> {
