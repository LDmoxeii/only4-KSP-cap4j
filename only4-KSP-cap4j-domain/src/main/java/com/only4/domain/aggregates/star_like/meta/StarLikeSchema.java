...
public class StarLikeSchema {
     ...
     * @return
     */
    public static Specification<StarLike> specify(Schema.PredicateBuilder<StarLikeSchema> builder, Schema.OrderBuilder<StarLikeSchema>... orderBuilders) {
     ...
     * @return
     */
    public static Specification<StarLike> specify(Schema.PredicateBuilder<StarLikeSchema> builder, List<Schema.OrderBuilder<StarLikeSchema>> orderBuilders) {
     ...
     * @return
     */
    public static Specification<StarLike> specify(Schema.PredicateBuilder<StarLikeSchema> builder, boolean distinct, Schema.OrderBuilder<StarLikeSchema>... orderBuilders) {
     ...
     * @return
     */
    public static Specification<StarLike> specify(Schema.PredicateBuilder<StarLikeSchema> builder, boolean distinct, List<Schema.OrderBuilder<StarLikeSchema>> orderBuilders) {
     ...
     * @return
     */
    public static Specification<StarLike> specify(Schema.Specification<StarLike, StarLikeSchema> specifier) {
        return (root, criteriaQuery, criteriaBuilder) -> {
            StarLikeSchema starLike = new StarLikeSchema(root, criteriaBuilder);
            return specifier.toPredicate(starLike, criteriaQuery);
        };
    }
