...
public class FollowMemberSchema {
    ...
    public Schema.Field<Long> followMemberId() {
        return root == null ? new Schema.Field<>("followMemberId") : new Schema.Field<>(root.get("followMemberId"));
    }
    ...
    public Schema.Field<Integer> followMemberName() {
        return root == null ? new Schema.Field<>("followMemberName") : new Schema.Field<>(root.get("followMemberName"));
    }
    ...
    public static Specification<FollowMember> specify(Schema.PredicateBuilder<FollowMemberSchema> builder, boolean distinct) {
        return (root, criteriaQuery, criteriaBuilder) -> {
            ...
            criteriaQuery.where(builder.build(followMember));
     ...
     * @return
     */
    public static Sort orderBy(Schema.OrderBuilder<FollowMemberSchema>... builders) {
     ...
     * @return
     */
    public static Sort orderBy(Collection<Schema.OrderBuilder<FollowMemberSchema>> builders) {
        if(null == builders || builders.isEmpty()) {
            return Sort.unsorted();
        }
        return Sort.by(builders.stream()
                .map(builder -> builder.build(new FollowMemberSchema(null, null)))
