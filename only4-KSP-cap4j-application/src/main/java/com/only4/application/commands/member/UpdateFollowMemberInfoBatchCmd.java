 ...
 * @date 2025/02/22
 */
public class UpdateFollowMemberInfoBatchCmd {

    /**
     * UpdateFollowMemberInfoBatchCmd命令请求实现
     */
    @Service
    ...
    public static class Handler implements Command<Request, Response> {
        ...
        public Response exec(Request cmd) {
            Mediator.repositories()
                    ...
                    .forEach(member -> {
                        member.updateFollowInfo(cmd.getOtherId(), cmd.getOtherName());
    ...
    /**
     * UpdateFollowMemberInfoBatchCmd命令请求参数
     */
    @Data
    @Builder
    @NoArgsConstructor
    ...
    /**
     * UpdateFollowMemberInfoBatchCmd命令响应
     */
    @Data
    @Builder
    @NoArgsConstructor
