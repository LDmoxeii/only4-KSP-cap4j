 ...
 * @date 2025/02/16
 */
public class UpdateMemberFanCountCmd {

    /**
     * UpdateMemberFanCountCmd命令请求实现
     */
    @Service
    ...
    public static class Handler implements Command<Request, Response> {
        ...
        public Response exec(Request cmd) {
            ...
            member.updateFanCount(cmd.getFanCount());
