...
/**
 * UpdateMemberFanCountCmd命令
 *
 * @author cap4j-ddd-codegen
 * @date 2025/02/16
 */
public class UpdateMemberLikeCountCmd {

    /**
     * UpdateMemberLikeCountCmd命令请求实现
     */
    @Service
    ...
    public static class Handler implements Command<Request, Response> {
        ...
        public Response exec(Request cmd) {
            ...
            member.updateLikeCount(cmd.getLikeCount());
    ...
    /**
     * UpdateMemberLikeCountCmd命令请求参数
     */
    @Data
    @Builder
    @NoArgsConstructor
