 ...
 * @date 2025/02/23
 */
public class UpdateStarCommentReplyLikeCountCmd {

    /**
     * UpdateStarCommentReplyLikeCountCmd命令请求实现
     */
    @Service
    ...
    /**
     * UpdateStarCommentReplyLikeCountCmd命令请求参数
     */
    @Data
    @Builder
    @NoArgsConstructor
    ...
    /**
     * UpdateStarCommentReplyLikeCountCmd命令响应
     */
    @Data
    @Builder
    @NoArgsConstructor
