...
@Constraint(validatedBy = ArticleCommentLiked.Validator.class)
public @interface ArticleCommentLiked {
    String message() default "还未过赞";
    ...
    class Validator implements ConstraintValidator<ArticleCommentLiked, RequestParam<?>> {
        private String articleIdStr;
        private String memberIdStr;
        private String commentId;
        public void initialize(ArticleCommentLiked constraintAnnotation) {
        ...
        public boolean isValid(RequestParam<?> request, ConstraintValidatorContext context) {
            try {
                ...
                return Mediator.repositories()
                        ...
                        .anyMatch(articleCommentLike -> Objects.equals(articleCommentLike.getMemberId(), memberId));
            } catch (Exception e) {
