...
@Constraint(validatedBy = MemberNotBanned.Validator.class)
public @interface MemberNotBanned {

    String message() default "用户已处于封禁状态";

    Class<?>[] groups() default {};

    Class<? extends Payload>[] payload() default {};

    class Validator implements ConstraintValidator<MemberNotBanned, Long> {
