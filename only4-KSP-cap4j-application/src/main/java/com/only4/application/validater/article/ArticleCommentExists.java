...
public @interface ArticleCommentExists {
    ...
    class Validator implements ConstraintValidator<ArticleCommentExists, RequestParam<?>> {
        private String articleIdStr;
        private String commentIdStr;

        @Override
        public void initialize(ArticleCommentExists constraintAnnotation) {
            ConstraintValidator.super.initialize(constraintAnnotation);
            articleIdStr = constraintAnnotation.articleIdStr();
            commentIdStr = constraintAnnotation.commentIdStr();
        }
        ...
        public boolean isValid(RequestParam request, ConstraintValidatorContext context) {
            try {
                ...
                Field commentIdField = request.getClass().getDeclaredField(commentIdStr);
                ...
                return Mediator.repositories()
                        ...
                        .anyMatch(articleComment -> Objects.equals(articleComment.getId(), commentId));
            } catch (Exception e) {
