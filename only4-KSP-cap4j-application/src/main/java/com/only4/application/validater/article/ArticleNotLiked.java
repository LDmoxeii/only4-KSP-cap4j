...
@Constraint(validatedBy = ArticleNotLiked.Validator.class)
public @interface ArticleNotLiked {
    ...
    class Validator implements ConstraintValidator<ArticleNotLiked, RequestParam<?>> {
        private String articleIdStr;
        private String memberIdStr;
        public void initialize(ArticleNotLiked constraintAnnotation) {
