...
@Constraint(validatedBy = FavoritesNotContainsArticle.Validator.class)
public @interface FavoritesNotContainsArticle {
    ...
    class Validator implements ConstraintValidator<FavoritesNotContainsArticle, RequestParam<?>> {
        private String memberIdStr;
        private String favoritesIdStr;
        private String articleIdStr;

        @Override
        public void initialize(FavoritesNotContainsArticle constraintAnnotation) {
