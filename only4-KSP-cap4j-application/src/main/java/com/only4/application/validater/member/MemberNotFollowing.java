...
@Constraint(validatedBy = MemberNotFollowing.Validator.class)
public @interface MemberNotFollowing {
    String message() default "用户间已建立关注关系";
        ...
        public boolean isValid(RequestParam request, ConstraintValidatorContext context) {
            try {
                ...
                return Mediator.repositories()
                        ...
                        .noneMatch(followMember -> Objects.equals(followMember.getId(), otherId));
            } catch (Exception e) {
